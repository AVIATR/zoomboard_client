...
class AJAlertController: UIViewController {
    ...
    private func setupAJAlertController(){
        ...
        //This is for title (App name) text color
        lblTitle.textColor = UIColor.blue
        lblAlertText?.text   = strAlertText
        //This is for message text color
        lblAlertText?.textColor = UIColor.black
